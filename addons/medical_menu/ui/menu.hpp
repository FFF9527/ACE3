...
class GVAR(medicalMenu) {
    ...
    // center
        ...
        class bodyImgBackground: ACE_gui_backgroundBase {
            ...
            colorPicture[] = {1,1,1,1};
            colorText[] = {1,1,1,1};
            text = QPATHTOEF(medical_ui,data\body_image\background.paa);
        };
        class bodyImgHead: bodyImgBackground {
            ...
            text = QPATHTOEF(medical_ui,data\body_image\head.paa);
        };

        class bodyImgTorso: bodyImgHead {
            idc = 51;
            text = QPATHTOEF(medical_ui,data\body_image\torso.paa);
        };
        class bodyImgArms_l: bodyImgHead {
            idc = 52;
            text = QPATHTOEF(medical_ui,data\body_image\arm_left.paa);
        };
        class bodyImgArms_r: bodyImgHead {
            idc = 53;
            text = QPATHTOEF(medical_ui,data\body_image\arm_right.paa);
        };
        class bodyImgLegs_l: bodyImgHead {
            idc = 54;
            text = QPATHTOEF(medical_ui,data\body_image\leg_left.paa);
        };
        class bodyImgLegs_r: bodyImgHead {
            idc = 55;
            text = QPATHTOEF(medical_ui,data\body_image\leg_right.paa);
        };
